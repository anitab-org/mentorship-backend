 ...
 * **bit** This branch is for MS-backend version specific to BridgeInTech project https://github.com/anitab-org/mentorship-backend/tree/bit . All the contributing PRs related to BIT-MS integration issue must be sent to this branch.
