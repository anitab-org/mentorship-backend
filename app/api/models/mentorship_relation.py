...
count_pending_requests_response_body = Model('Count pending mentorship relations', {
    'count': fields.Integer(required=True, description='Count of total pending mentorship requests this user')
})
