...
count_pending_requests_response_body = Model('Count pending requests response model',{
    'count' : fields.Integer(required=True, description='Number of pending requests')
})
