...
class AdminDAO:
    """Data Access Object for Admin endpoint."""
    ...
    def assign_new_user(user_id, data):
        ...
        Creates a new admin if the assigned user exists and is assigned by
        another user. Otherwise returns a message.
    ...
    def revoke_admin_user(user_id, data):
        ...
        Revokes the admin status of an user if the user exists, is an admin and
         another user requests for this action. Otherwise returns a message.
