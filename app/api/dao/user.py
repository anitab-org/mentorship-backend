...
class UserDAO:
    """Data Access Object for User endpoint"""
    ...
    def create_user(data):
        ...
        Arguments:
            data: A list containing the user's name, username, password,
            and email, as well as recognition that they have read and agree
        ...
        Returns:
            ...
            whether or not the user was created successfully.
    ...
    def delete_user(user_id):
        ...
        Deletes the specified user and removes them from the directory,
        with checks to make sure that the user exists
        and is not the only administrator.
    ...
    def get_user(user_id):
        ...
        Provides the user profile of the user whose ID
        ...
        Returns:
            The UserModel class of the user whose ID was searched, containing
            the public information of their profile such as bio, location, etc.
    ...
    def get_user_by_email(email):
        ...
        Provides the user profile of the user whose email
        matches the one specified.
        ...
        Returns:
            The UserModel class of the user whose email was searched,
            containing the public information of their profile such as
            bio, location, etc.
    ...
    def get_user_by_username(username):
        ...
        Provides the user profile of the user whose username
        matches the one specified.
        ...
        Returns:
            The UserModel class of the user whose username was searched,
            containing the public information of their profile such as
            bio, location, etc.
    ...
    def list_users(user_id, is_verified=None):
        ...
        Arguments:
            ...
            is_verified: Status of the user's verification;
            None when provided as an argument.
    ...
    def update_user_profile(user_id, data):
        ...
        Replaces old data items with new ones in the provided data list,
        with a check for overlap between users in username
        and a check that a user with the specified ID exists
        
        Arguments:
            user_id: The ID of the user whose data will be updated.
            data: A list containing the user's information such as
            name, bio, location, etc.
        
        Returns:
            A message that indicates whether the update was successful or not
    ...
    def change_password(user_id, data):
        ...
        Returns:
            A message that indicates whether the password change was successful
            or not and a second element which is the HTTP response code.
    ...
    def confirm_registration(token):
        ...
        Determines whether a user's email registration was
        invalid, previously confirmed, or just confirmed.
        
        Arguments:
            token: Serialized and signed email address as a URL safe string.
        
        Returns:
            A message that indicates if the confirmation was invalid,
            already happened, or just happened, and the HTTP response code.
    ...
    def authenticate(username_or_email, password):
        ...
        Arguments:
            username_or_email: The username or email associated with
            the account being authenticated.
            password: The password associated with the account being
            authenticated.
            
        Returns:
            Returns authenticated user if username and password are valid,
    ...
    def get_user_statistics(user_id):
        ...
        all_relations = user.mentor_relations + user.mentee_relations
        (pending_requests, accepted_requests, rejected_requests,
         completed_relations, cancelled_relations) = (
            0, 0, 0, 0, 0)
        for relation in all_relations:
