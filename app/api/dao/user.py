...
class UserDAO:
    ...
    def get_user_by_username(username):
        ...
        Arguments:
            username: The username of the user to be searched.
    ...
    def get_users_by_name(name):
        """ Retrieves a list of users' profile information using a specified name.

        Provides the user profile of the user whose name matches the one specified.

        Arguments:
            name: The name of the user to be searched.

        Returns:
            The UserModel class of the user whose name was searched, containing the public information of their profile such as bio, location, etc.

        """

        return UserModel.find_by_name(name)
