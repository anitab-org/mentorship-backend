...
class UserDAO:
    ...
    def create_user(data):
        ...
        Arguments:
            data: A list containing the user's name, username, password, and
            email, as well as recognition that they have read and agree to the
        ...
        Returns:
            ...
            whether or not the user was created successfully. The second is the
            HTTP response code.
        """
    ...
    def delete_user(user_id):
        ...
        Deletes the specified user and removes them from the directory, with
        checks to make sure that the user exists and is not the only
        administrator.
        ...
        Returns:
            A tuple with two elements. The first element is a dictionary
            containing a key 'message' containing a string which indicates
            whether or not the user was created successfully. The second is
    ...
    def get_user(user_id):
        ...
        Provides the user profile of the user whose ID matches
        the one specified.
    ...
    def get_user_by_email(email):
        ...
        Provides the user profile of the user whose email matches
        the one specified.
        ...
        Returns:
            ...
            containing the public information of their profile such as bio,
            location, etc.
    ...
    def get_user_by_username(username):
        ...
        Provides the user profile of the user whose username matches
        the one specified.
    ...
    def list_users(user_id, is_verified=None):
        ...
        Arguments:
            ...
            is_verified: Status of the user's verification; None when
    ...
    def update_user_profile(user_id, data):
        ...
        Replaces old data items with new ones in the provided data list, with
        a check for overlap between users in username and a check that a user
        with the specified ID exists

        Arguments:
            user_id: The ID of the user whose data will be updated.
            data: A list containing the user's information such as name, bio,
            location, etc.
    ...
    def confirm_registration(token):
        ...
        Determines whether a user's email registration was invalid, previously
        confirmed, or just confirmed.

        Arguments:
            token: Serialized and signed email address as a URL safe string.

        Returns:
            A message that indicates if the confirmation was invalid, already
            happened, or just happened, and the HTTP response code.
