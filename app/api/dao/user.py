...
class UserDAO:
    ...
    @staticmethod
    def list_users(user_id: int, search_query: str = "", is_verified: bool = None, page: int = 1):
    ...
    def get_user_dashboard(user_id):
        """
        Returns user dashboard, that is:
          -relations of all states, sent or received:
        Also returns all tasks if the user is in a relation.
