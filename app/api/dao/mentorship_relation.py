...
class MentorshipRelationDAO:
    ...
    def create_mentorship_relation(self, user_id, data):
        ...
        is_valid_user_ids = (
            action_user_id in (mentor_id, mentee_id)
        )
        if not is_valid_user_ids:
            return (
                {
                    "message": (
                        "Your ID has to match " "either Mentor or Mentee IDs."
                    )
                },
                400,
            )
        ...
        if mentor_id == mentee_id:
            return (
                {
                    "message": (
                        "You cannot have a mentorship relation "
                        "with yourself."
                    )
                },
                400,
        ...
        if max_relation_duration > self.MAXIMUM_MENTORSHIP_DURATION:
            return (
                {
                    "message": (
                        "Mentorship relation maximum duration " "is 6 months."
                    )
                },
                400,
            )
    ...
    def accept_request(user_id, request_id):
        ...
        if request is None:
            return (
                {
                    "message": (
                        "This mentorship relation request " "does not exist."
                    )
                },
                404,
            )
        ...
        if request.action_user_id is user_id:
            return (
                {
                    "message": (
                        "You cannot accept a mentorship request "
                        "sent by yourself."
                    )
                },
                400,
        ...
        if not (request.mentee_id is user_id or request.mentor_id is user_id):
            return (
                {
                    "message": (
                        "You cannot accept a mentorship relation w"
                        "here you are not involved."
                    )
                },
                400,
            )
    ...
    def reject_request(user_id, request_id):
        ...
        if request.action_user_id is user_id:
            return (
                {
                    "message": (
                        "You cannot reject a mentorship request "
                        "sent by yourself."
                    )
                },
                400,
        ...
        if not (request.mentee_id is user_id or request.mentor_id is user_id):
            return (
                {
                    "message": (
                        "You cannot reject a mentorship relation "
    ...
    def cancel_relation(user_id, relation_id):
        ...
        if not (request.mentee_id is user_id or request.mentor_id is user_id):
            return (
                {
                    "message": (
                        "You cannot cancel a mentorship relation "
                        "where you are not involved."
                    )
                },
                400,
    ...
    def delete_request(user_id, request_id):
        ...
        if request.action_user_id is not user_id:
            return (
                {
                    "message": (
                        "You cannot delete a mentorship request "
    ...
    def list_pending_mentorship_relations(user_id):
        ...
        for relation in all_relations:
            if (
                    relation.state is MentorshipRelationState.PENDING
