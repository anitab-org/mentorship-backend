...
from app.api.validations.mentorship_relation import verify_request
...
class MentorshipRelationDAO:
    """Data Access Object for mentorship relation endpoint.
    ...
    # helper function that helps to avoid code duplicates
    ...
    def create_mentorship_relation(self, user_id, data):
        ...
        Args:
            ...
            data: List containing the mentor_id, mentee_id, end_date_timestamp
            and notes.
        ...
        is_valid_user_ids = action_user_id == mentor_id or \
                            action_user_id == mentee_id
    ...
    def list_mentorship_relations(user_id=None, accepted=None, pending=None,
                                  completed=None, cancelled=None,
                                  rejected=None):
        """Lists all relationships of a given user.

        Lists all relationships of a given user.
        Support for filtering not yet implemented.

        Args:
            user_id: ID of the user whose relationships are to be listed.
            accepted: boolean that indicates if relation must be accepted
            pending: boolean that indicates if relation must be pending
            completed: boolean that indicates if relation must be completed
            cancelled: boolean that indicates if relation must be cancelled
            rejected: boolean that indicates if relation must be rejected

        Returns:
            message: A message corresponding to the completed action;
            success if all relationships of a given user are listed,
    ...
    def accept_request(user_id, request_id):
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if mentorship relation request is accepted,
            failure if otherwise.
        """
        ...
        is_valid = verify_request(request)
    ...
    def reject_request(user_id, request_id):
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if mentorship relation request is rejected,
            failure if otherwise.
        """
    ...
    def cancel_relation(user_id, relation_id):
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if mentorship relation is terminated,
            failure if otherwise.
        """
    ...
    def delete_request(user_id, request_id):
        ...
        Deletes a mentorship request if the current user was the one
        who created it and the request is in the pending state.
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if mentorship relation request is deleted,
            failure if otherwise.
        """
    ...
    def list_past_mentorship_relations(user_id):
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if past mentorship relation details are listed,
            failure if otherwise.
        """
    ...
    def list_current_mentorship_relation(user_id):
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if current mentorship relation details are listed,
            failure if otherwise.
        """
    ...
    def list_pending_mentorship_relations(user_id):
        ...
        Returns:
            message: A message corresponding to the completed action;
            success if pending mentorship relation requests are listed,
            failure if otherwise.
        """
        ...
        for relation in all_relations:
            if relation.state == MentorshipRelationState.PENDING and \
