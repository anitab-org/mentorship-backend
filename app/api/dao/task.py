...
class TaskDAO:
    ...
    def list_tasks(user_id, mentorship_relation_id):
        ...
        Returns:
            A list containing all the tasks one user has in a
            mentorship relation. Otherwise, it returns a two
            element list where the first element is
            a dictionary containing a key 'message' indicating in its
            value if there were any problem finding user's tasks in the
            specified mentorship relation as a string.
        ...
        if user_id != relation.mentee_id and user_id != relation.mentor_id:
    ...
    def complete_task(user_id, mentorship_relation_id, task_id):
        ...
        Returns:
            ...
            if the task was set to complete successfully or not as a string.
            The last element is the HTTP response code.
        """
