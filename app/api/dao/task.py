...
class TaskDAO:
    ...
    def create_task(user_id, mentorship_relation_id, data):
        """Creates a new task.
           ...
           Creates a new task in a mentorship relation if the
           specified user is already involved in it.
           ...
           Returns:
                ...
                containing a key 'message' indicating
        ...
        relation = \
            MentorshipRelationModel.find_by_id(_id=mentorship_relation_id)
        if relation is None:
    ...
    def list_tasks(user_id, mentorship_relation_id):
        """Retrieves all tasks of a user in a mentorship relation.
           ...
           Lists all tasks from a mentorship relation for the specified
           user if the user is involved in a current mentorship relation.
           ...
           Returns:
                ...
                relation. otherwise, it returns a two element list
                where the first element is
                a dictionary containing a key 'message' indicating in its
                value if there were any problem finding
                user's tasks in the specified
    ...
    def delete_task(user_id, mentorship_relation_id, task_id):
        """Deletes a specified task from a mentorship relation.
           ...
           Deletes a task that belongs to a user who is involved
           in the specified mentorship relation.
           ...
           Returns:
                ...
                dictionary containing a key 'message'
                indicating in its value if the
                task was deleted succesfully or not as a string.
                The last element is the HTTP response code.
        """
    ...
    def complete_task(user_id, mentorship_relation_id, task_id):
        """Marks a task as completed.
           ...
           Updates the task that belongs to a user who is involved
           in the specified mentorship relation to finished task status.
           ...
           Returns:
                A two element list where the first element is a
                dictionary containing a key 'message' indicating in its value
                if the task was set to complete succesfully or not as a string.
                The last element is the HTTP response code.
        """
