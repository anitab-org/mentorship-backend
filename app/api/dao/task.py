...
class TaskDAO:
    ...
    def create_task(user_id, mentorship_relation_id, data):
        ...
        Creates a new task in a mentorship relation if the specified user is
        ...
        relation = MentorshipRelationModel\
            .find_by_id(_id=mentorship_relation_id)
        if relation is None:
        ...
        relation.tasks_list.add_task(description=description,
    ...
    def list_tasks(user_id, mentorship_relation_id):
        ...
        Returns:
            ...
            relation. otherwise, it returns a two element list where
            the first element is a dictionary containing a key 'message'
            indicating in its value if there were any problem finding user's
            tasks in the specified mentorship relation as a string.
        ...
        if not (user_id == relation.mentee_id or user_id
                == relation.mentor_id):
    ...
    def delete_task(user_id, mentorship_relation_id, task_id):
        ...
        Returns:
            A two element list where the first element is a dictionary
            containing a key 'message' indicating in its value if the
    ...
    def complete_task(user_id, mentorship_relation_id, task_id):
        ...
        if task.get('is_done'):
            ...
            relation.tasks_list.update_task(
                task_id=task_id, is_done=True, completed_at=datetime
                    .now().timestamp())
