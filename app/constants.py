#  comment = Invalid fields'
NAME_INPUT_BY_USER_IS_INVALID = "Your name is invalid." 
EMAIL_INPUT_BY_USER_IS_INVALID = "Your email is invalid." 
USERNAME_INPUT_BY_USER_IS_INVALID = "Your username is invalid"
NEW_USERNAME_INPUT_BY_USER_IS_INVALID = "Your new username is invalid."  
...
FIELD_NEED_MENTORING_IS_NOT_VALID = "Field need_mentoring is not valid."  
FIELD_AVAILABLE_TO_MENTOR_IS_NOT_VALID = "Field available_to_mentor is not valid." 
...
MENTOR_DOES_NOT_EXIST = "Mentor user does not exist." 
MENTEE_DOES_NOT_EXIST = "Mentee user does not exist." 
...
NAME_FIELD_IS_MISSING = "Name field is missing." 
...
DESCRIPTION_FIELD_IS MISSING = "Description field is missing"
...
USER_CANNOT_DELETE_HIS_ACCOUNT_WHILE_HE_IS_THE_ONLY_ADMIN_LEFT = "You cannot delete your account, since you are the only Admin left." 
USER_CANNOT_REVOKE_ADMIN_STATUS = "You cannot revoke your admin status." 
USER_TRIED_TO_ASSIGN_SOMEONE_ELSE_AS_ADMIN_WHEN_HE_HIMSELF_IS_NOT_AN_ADMIN = "You don't have admin status. You can't assign other user as admin'
USER_TRIED_TO_REVOKE_SOMEONE_ELSE_AS_ADMIN_WHEN_HE_HIMSELF_IS_NOT_AN_ADMIN = "You don't have admin status. You can't revoke other admin user." 
 
# comment = Mentor availability."  
MENTOR_USER_IS_NOT_AVAILABLE_TO_MENTOR = "Mentor user is not available to mentor." 
MENTOR_IS_ALREADY_IN_A_RELATIONSHIP = "Mentor user is already in a relationship." 

# comment = Mentee availability'
...
# comment = Mismatch of fields'
USER_INPUT_HAS TO MATCH_EITHER_MENTOR_OR_MENTEE = "Your ID has to match either Mentor or Mentee IDs." 

#comment = update
NO_DATA_FOR UPDATING_PROFILE_WAS_SENT = "No data for updating profile was sent"

# comment = Relation constraints'
...
USER_IS_INVOLVED_IN_A_MENTORSHIP_RELATION = "You are currently involved in a mentorship relation." 
USER_IS_NOT_INVOLVED_IN_THIS_MENTORSHIP_RELATION = "You are not involved in this mentorship relation." 
USER_USES_A_USERNAME_THAT_ALREADY_EXISTS = "A user with that username already exists." 
...
# comment = Mentorship state." 
MENTOR_RELATIONSHIP_IS_NOT_IN_PENDING_STATE = "This mentorship relation is not in the pending state." 
MENTOR_RELATIONSHIP_STATUS_IS_NOT_IN_ACCEPTED_STATE = "This mentorship relation status is not in the accepted state." 
MENTORSHIP_RELATION_IS_NOT_IN_ACCEPTED_STATE = "Mentorship relation is not in the accepted state." 
 
# comment = Login errors." 
USER_ENTERED_INCORRECT_PASSWORD = "Current password is incorrect." 
EMAIL_EXPIRED_OR_TOKEN_IS_INVALID = "The confirmation link is invalid or the token has expired." 
...
USER_SUCCESSFULLY_UPDATED = "User was updated successfully." 
PASSWORD_SUCCESSFULLY_UPDATED = "Password was updated successfully"

#confimation
ACCOUNT_ALREADY_CONFIRMED = "Account already confirmed"
USER_ALREADY_CONFIRMED_ACCOUNT = "You already confirm your email"
ACCOUNT_ALREADY_CONFIRMED_AND THANKS = "You have confirmed your account. Thanks!"
