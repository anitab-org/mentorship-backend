...
class TestTaskCommentDao(TasksBaseTestCase):
    ...
    def create_task_comment():
        dao = TaskCommentDAO()
        dao.create_task_comment(user_id=1, task_id=1, relation_id=2,
                                comment='comment')
    ...
    def test_dao_modify_comment(self):
        ...
        TaskCommentDAO.modify_comment(user_id=1, _id=1, task_id=1,
                                      relation_id=2, comment='modified comment')
    ...
    def test_dao_delete_comment(self):
        ...
        TaskCommentDAO.delete_comment(user_id=1, _id=1, task_id=1,
                                      relation_id=2)
