...
class TestUserDao(BaseTestCase):
    ...
    def test_dao_get_user_dashboard(self):
        expected_response = {
            'as_mentor': {
                'sent': {
                    'accepted': [DashboardRelationResponseModel(self.mentorship_relation1).response],
                    'rejected': [],
                    'completed': [],
                    'cancelled': [],
                    'pending': [DashboardRelationResponseModel(self.mentorship_relation2).response]
                },
                'received': {
                    'accepted': [],
                    'rejected': [],
            ...
            'as_mentee': {
                ...
                'received': {
                    ...
                    'rejected': [],
                    'completed': [],
                    'cancelled': [DashboardRelationResponseModel(self.mentorship_relation3).response],
                    'pending': []
                }
            },
