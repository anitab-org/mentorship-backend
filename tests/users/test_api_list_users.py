...
class TestListUsersApi(BaseTestCase):
    ...
    def test_list_users_api_with_a_partial_page_and_per_page_query_resource_auth(
        self,
    ):
        auth_header = get_test_request_header(self.admin_user.id)
        expected_response = [marshal(self.second_user, public_user_api_model)]
    ...
    def test_list_users_api_with_a_search_query_with_username_resource_auth(
        self,
    ):
        auth_header = get_test_request_header(self.admin_user.id)
        expected_response = [
