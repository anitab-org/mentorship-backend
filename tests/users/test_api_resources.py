...
class TestUserRegistrationApi(BaseTestCase):
    ...
    def test_user_registration_without_optional_fields(self,
                                                       send_email_function):
        ...
        with self.client:
            ...
            if user is None:
                ...
                self.assertEqual(user1['terms_and_conditions_checked'],
    ...
    @patch('flask_mail._MailMixin.send', side_effect=mail_send_mocked)
    def test_user_registration_with_both_optional_fields(self,
                                                         send_email_function):
        with self.client:
