...
from app.api.validations.user import validate_user_registration_request_data, \
    NAME_MIN_LENGTH, NAME_MAX_LENGTH, \
    USERNAME_MIN_LENGTH, USERNAME_MAX_LENGTH, PASSWORD_MAX_LENGTH, \
    PASSWORD_MIN_LENGTH, validate_new_password
...
class TestUserApiRequestDataValidation(unittest.TestCase):
    ...
    def test_user_registration_request_data_name_inferior_to_limit(self):
        ...
        expected_result = {
            "message": get_length_validation_error_message("name",
                                                           NAME_MIN_LENGTH,
                                                           NAME_MAX_LENGTH)}
        actual_result = validate_user_registration_request_data(request_body)
    ...
    def test_user_registration_request_data_username_inferior_to_limit(self):
        ...
        expected_result = {
            "message": get_length_validation_error_message("username",
                                                           USERNAME_MIN_LENGTH,
                                                           USERNAME_MAX_LENGTH)}
        actual_result = validate_user_registration_request_data(request_body)
    ...
    def test_user_registration_request_data_password_inferior_to_limit(self):
        ...
        expected_result = {
            "message": get_length_validation_error_message("password",
                                                           PASSWORD_MIN_LENGTH,
                                                           PASSWORD_MAX_LENGTH)}
        actual_result = validate_user_registration_request_data(request_body)
    ...
    def test_user_password_change_request_password_inferior_to_limit(self):
        ...
        random_generated_password = "".join(
            secure_random.choice(ascii_lowercase) for x in
            range(PASSWORD_MIN_LENGTH - 1))
        data = dict(new_password=random_generated_password,
                    current_password=random_generated_password)

        expected_result = {
            "message": get_length_validation_error_message("new_password",
                                                           PASSWORD_MIN_LENGTH,
                                                           PASSWORD_MAX_LENGTH)}
