...
class TestUpdateUserApi(BaseTestCase):
    ...
    def test_update_availability_to_mentor_more_than_once(self):
        ...
        actual_response = self.client.put(
            ...
            headers=auth_header,
            data=json.dumps(dict(
                available_to_mentor=test_mentor_availability)),
            content_type='application/json')
        ...
        actual_response = self.client.put(
            ...
            headers=auth_header,
            data=json.dumps(dict(
                available_to_mentor=not test_mentor_availability)),
            content_type='application/json')
    ...
    def test_update_availability_to_be_mentee_to_false(self):
        ...
        actual_response = self.client.put(
            ...
            headers=auth_header,
            data=json.dumps(dict(
                need_mentoring=test_need_mentoring)),
            content_type='application/json')
