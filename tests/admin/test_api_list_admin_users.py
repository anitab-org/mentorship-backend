...
class TestListAdminUsersApi(BaseTestCase):
    def setUp(self):
        ...
        self.admin_user_2 = UserModel(
            ...
            terms_and_conditions_checked=test_admin_user_2['terms_and_conditions_checked']
        )
        ...
        self.admin_user_3 = UserModel(
            ...
            terms_and_conditions_checked=test_admin_user_3['terms_and_conditions_checked']
        )
    ...
    def test_list_admin_users_api_resource_auth_admin(self):
        ...
        expected_response = [marshal(self.admin_user, public_admin_user_api_model),
                    marshal(self.admin_user_3, public_admin_user_api_model),]
        actual_response = self.client.get('/admins', follow_redirects=True, headers=auth_header)
