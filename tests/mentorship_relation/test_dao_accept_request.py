...
# TODO test when a user is in a current relation
#      and tries to accept another relation

# TODO test when a user tries to accept a relation
...
class TestMentorshipRelationAcceptRequestDAO(MentorshipRelationBaseTestCase):
    ...
    def test_dao_requester_tries_to_accept_mentorship_request(self):
        ...
        self.assertEqual(
            (
                {
                    "message": "You cannot accept a mentorship request "
                               "sent by yourself."
                },
                400,
            ),
